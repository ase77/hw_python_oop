...
передав ему на вход параметры, полученные во втором аргументе. Этот объект функция возвращает.
...
результат метода является объект класса `InfoMessage`, он сохраняется в переменную `info`.
